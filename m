...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 764589976B
	for <lists+linux-iio@lfdr.de>; Thu, 22 Aug 2019 16:53:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387623AbfHVOxB (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Thu, 22 Aug 2019 10:53:01 -0400
Received: from mail-lf1-f65.google.com ([209.85.167.65]:36839 "EHLO
        mail-lf1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388028AbfHVOxA (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Thu, 22 Aug 2019 10:53:00 -0400
Received: by mail-lf1-f65.google.com with SMTP id j17so4757055lfp.3
        for <linux-iio@vger.kernel.org>; Thu, 22 Aug 2019 07:52:55 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=KCI/fJQBxx9fmBRwRnmA1wGNvFCphxIoNwyDTe+wxOU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=KCI/fJQBxx9fmBRwRnmA1wGNvFCphxIoNwyDTe+wxOU=;
        b=
X-Gm-Message-State: APjAAAWcAOh2jALceZDY+b6iVobUUiCYLMc/ZRzP7w+kjA+HTMpc89nR
        XhXYRn1aTRTvMgDjFE1IZ+nw8A==
X-Google-Smtp-Source: APXvYqymXykYhseCRXuy0oyB/T6oKQU7r7KOQxrA2V31VgQ+L0jN779Ptg9wy8ImMSHTOl81XipSmA==
X-Received: by 2002:ac2:43d0:: with SMTP id u16mr269582lfl.38.1566485574038;
        Thu, 22 Aug 2019 07:52:54 -0700 (PDT)
Received: from genomnajs.ideon.se ([85.235.10.227])
        by smtp.gmail.com with ESMTPSA id s3sm3959374ljj.85.2019.08.22.07.52.52
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 22 Aug 2019 07:52:52 -0700 (PDT)
...
Subject: [PATCH 7/8 v2] mfd: Switch the AB8500 GPADC to IIO
Date:   Thu, 22 Aug 2019 16:52:32 +0200
Message-Id: <20190822145233.18222-8-linus.walleij@linaro.org>
...
index f026ada68f6a..f7d22d90d944 100644
--- a/drivers/mfd/Makefile
+++ b/drivers/mfd/Makefile
@@ -179,7 +179,6 @@ obj-$(CONFIG_ABX500_CORE)	+= abx500-core.o
...
index d24c6ecccb88..bd2145afc581 100644
...
-
  ...
  * numerical value.
@@ -2645,7 +2011,6 @@ static const struct file_operations ab8500_hwreg_fops = {
 };
...
-static struct dentry *ab8500_gpadc_dir;
 ...
 {
@@ -2697,11 +2062,6 @@ static int ab8500_debug_probe(struct platform_device *plf)
 	if (!ab8500_dir)
 		goto err;
...
-
 	...
 	if (!file)
@@ -2772,165 +2132,6 @@ static int ab8500_debug_probe(struct platform_device *plf)
 	if (!file)
 		goto err;
