Return-Path: <linux-iio+bounces-8945-lists+linux-iio=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-iio@lfdr.de
Delivered-To: lists+linux-iio@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE9596770D
	for <lists+linux-iio@lfdr.de>; Sun,  1 Sep 2024 16:25:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C2C1D1C20CED
	for <lists+linux-iio@lfdr.de>; Sun,  1 Sep 2024 14:25:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E3DB817E8E5;
	Sun,  1 Sep 2024 14:25:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="AcXaoheg"
X-Original-To: linux-iio@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A4A3723AB
	for <linux-iio@vger.kernel.org>; Sun,  1 Sep 2024 14:25:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725200729; cv=none; b=q5uR5z7lf4UDoeyfCRJf1QwgR81ZDPpMQkqn3RO4M/AVDaOxPG2PjDphRZkdWrBxI6F02JHtAXBMHu9XsTcWBRKtgv+eiU7WpEh5F/uzL8IuaDCYY8k5HNb6jqPg3OcmNx/JPhRQVPmkSvzsiuGWqqPwLgX1etZtFOw9UmxfUWQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725200729; c=relaxed/simple;
	bh=riNjfMmY6eoJ7r6cIg+6LDLPXRjK6ayRYsIixFjbzK8=;
	h=Date:From:To:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=V09yYodS0qlmMxPYnqa11PubgZNlltiJ8czWU7nIVkqOw1SqvgEbKm8k8YJ2qSUSa9rTcFr2j2kEbANaRFgObRebppr40+95AoT78gHz+MsaTa26uM86m8k6+LNfGE+0lo6igKQ2FopXfUxqyvvHDHxRss52uVShJojTMS2CUsE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=AcXaoheg; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id EEA61C4CEC3;
	Sun,  1 Sep 2024 14:25:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1725200729;
	bh=riNjfMmY6eoJ7r6cIg+6LDLPXRjK6ayRYsIixFjbzK8=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
	b=
Date: Sun, 1 Sep 2024 15:25:24 +0100
From: Jonathan Cameron <jic23@kernel.org>
To: linux-iio@vger.kernel.org
Cc: Jonathan Cameron <Jonathan.Cameron@huawei.com>
Subject: Re: [PATCH] iio: adc: standardize on formatting for id match tables
Message-ID: <20240901152524.1e00ea3d@jic23-huawei>
In-Reply-To: <20240818180912.719399-1-jic23@kernel.org>
References: <20240818180912.719399-1-jic23@kernel.org>
...
On Sun, 18 Aug 2024 19:09:12 +0100
...
Whilst I'm not fond of taking patches with no reviews on list, this
one is so utterly trivial I don't really want to waste anyone's time
by poking them to look at it.
