...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DA8F1FEFCB
	for <lists+linux-iio@lfdr.de>; Sat, 16 Nov 2019 17:02:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730066AbfKPQAz (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Sat, 16 Nov 2019 11:00:55 -0500
Received: from mail.kernel.org ([198.145.29.99]:42020 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730375AbfKPQAy (ORCPT <rfc822;linux-iio@vger.kernel.org>);
        Sat, 16 Nov 2019 11:00:54 -0500
Received: from archlinux (cpc149474-cmbg20-2-0-cust94.5-4.cable.virginm.net [82.4.196.95])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 033C22089D;
        Sat, 16 Nov 2019 16:00:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1573920053;
        bh=GSoGYHD/RtSCk+/b84RKr0PzP8bXGCJiAJn+CoZRSC8=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=bBBr6xvmqOYeqrgWPyk3tYs72n8rGyUTuc1wQ9RRDq4d1clYqBPerG4mgCGunBeyY
         gqggtObHCqj3nb+J9MaMMrz1Td2mBkoEiPH+CdZ1n1XPhvcg5D4m7OrVIf1/ya/l2d
         9FREUtdSIAYduvNnmUJLWL5KWggVj3pPVObOkVIE=
Date:   Sat, 16 Nov 2019 16:00:47 +0000
...
Message-ID: <20191116160038.0e09bec9@archlinux>
In-Reply-To: <20191116155808.69b867f0@archlinux>
References: <20191114105159.14195-1-u.kleine-koenig@pengutronix.de>
        <20191114105159.14195-3-u.kleine-koenig@pengutronix.de>
        <20191116155808.69b867f0@archlinux>
...
The SPI driver however definitely needs those guarantees. Comments in patch=
 3.
...
> > +	__be32 buf ____cacheline_aligned; =20
>=20
...
> > +}
> > +
> > +static int ltc249x_read(struct ltc249x_driverdata *ddata, u8 address, =
int *val)
> > +{
> > +	int ret;
> > +
