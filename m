...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B93A568B08B
	for <lists+linux-iio@lfdr.de>; Sun,  5 Feb 2023 16:22:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229580AbjBEPWa (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Sun, 5 Feb 2023 10:22:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40412 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229550AbjBEPW3 (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Sun, 5 Feb 2023 10:22:29 -0500
Received: from www381.your-server.de (www381.your-server.de [78.46.137.84])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 223EA18B
        for <linux-iio@vger.kernel.org>; Sun,  5 Feb 2023 07:22:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=metafoo.de;
        s=default2002; h=Content-Transfer-Encoding:Content-Type:In-Reply-To:From:
        References:Cc:To:Subject:MIME-Version:Date:Message-ID:Sender:Reply-To:
        Content-ID:Content-Description:Resent-Date:Resent-From:Resent-Sender:
        Resent-To:Resent-Cc:Resent-Message-ID;
        bh=hs9eTc2NOjUUud2V19lQuw28sLwJLrzImwEKa38AZds=; b=fIsj1yHspUNBHpNzqspQZW8U3g
        ;
Received: from sslproxy01.your-server.de ([78.46.139.224])
        by www381.your-server.de with esmtpsa  (TLS1.3) tls TLS_AES_256_GCM_SHA384
        (Exim 4.94.2)
        (envelope-from <lars@metafoo.de>)
        id 1pOgqR-0008rm-0c; Sun, 05 Feb 2023 16:22:19 +0100
Received: from [2604:5500:c0e5:eb00:da5e:d3ff:feff:933b]
        by sslproxy01.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <lars@metafoo.de>)
        id 1pOgqQ-000T7Q-Cs; Sun, 05 Feb 2023 16:22:18 +0100
Message-ID: <6e65ee36-faa3-b652-223e-e85dee66a0f9@metafoo.de>
Date:   Sun, 5 Feb 2023 07:22:16 -0800
MIME-Version: 1.0
...
In-Reply-To: <20230205150956.09bb8e6d@jic23-huawei>
