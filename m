...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3BDD113080B
	for <lists+linux-iio@lfdr.de>; Sun,  5 Jan 2020 13:53:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726029AbgAEMxp (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Sun, 5 Jan 2020 07:53:45 -0500
Received: from mail.kernel.org ([198.145.29.99]:53484 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725990AbgAEMxp (ORCPT <rfc822;linux-iio@vger.kernel.org>);
        Sun, 5 Jan 2020 07:53:45 -0500
Received: from archlinux (cpc149474-cmbg20-2-0-cust94.5-4.cable.virginm.net [82.4.196.95])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 3DD3720866;
        Sun,  5 Jan 2020 12:53:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1578228823;
        bh=ToxOdbDAU4mCbpIHPJfNGCFMmi6mVH0ibDEaeyKoB60=;
        h=Date:From:To:Subject:In-Reply-To:References:From;
        b=umqrQGim0DdpYOSIGHSk2HKEQ3PezkW72UOB2O6QEKcxZLjdCmJaMVibIpQixr6mh
         4bmrJJ6RZSeM2ieCMDl74mFX5Iwyg64jKf0YWZ036Xv4oEyWdPz/wlq90YEW0X4ctb
         6fxVpqrgOEB/E/s3oJh91xTcORuyFcUIg0n8ajvA=
Date:   Sun, 5 Jan 2020 12:53:33 +0000
From:   Jonathan Cameron <jic23@kernel.org>
To:     gregkh@linuxfoundation.org, linux-iio@vger.kernel.org
Subject: Re: [PULL] First set of IIO new device support, features and
 cleanups for the 5.6 cycle
Message-ID: <20200105125333.60db3e63@archlinux>
...
> The following changes since commit 2611045e3555cd0d75837ae69ffd70ef51e28b=
f7:
>=20
>   staging: vchiq: Refactor indentation in vchiq_platform_conn_state_chang=
ed() (2019-11-15 14:14:55 +0800)
>=20
...
>=20
> ----------------------------------------------------------------
> First set of new device support, features and cleanups for IIO in the 5.6=
 cycle
>=20
> New device support
>=20
...
>   - Rename read_first_n callback to read.   The reasons behind the origin=
al
>     naming are lost to the mists of time.
> * ad799x
>   - Allow pm_ops to disable device completely allowing regulator power do=
wn.
> * bma180
...
>   - Drop linux/gpio.h and linux/of_gpio.h from drivers that don't use the=
m.
> * ad7266
...
> * ad7887
>   - Simplify channel specification assignment to enable adding more devic=
es.
> * ad7923
>   - Drop some unused and largely pointless defines of BOB_N=3D=3DN variet=
y.
...
>   - Use c99 style explicity .member assignment to make driver more readab=
le.
> * bmp280
...
> * dmaengine buffer
>   - Use dma_request_chan instead of dma_request_slave_channel_reason as t=
hat
>     ABI is going away.
...
>       iio: imu: adis[16480]: group RW into a single lock in adis_enable_i=
rq()
...
>=20
> Andrea Merello (9):
>       iio: max31856: add option for setting mains filter rejection freque=
ncy
>       Documentation: ABI: document IIO in_temp_filter_notch_center_freque=
ncy file
...
>       dt-bindings: iio: maxim_thermocouple: document new 'compatible' str=
ings
>=20
> Andreas Klinger (4):
...
>       iio: pressure: st_press: Mark default_press_pdata with __maybe_unus=
ed
...
>       iio: imu: st_lsm6dsx: export max num of slave devices in st_lsm6dsx=
_shub_settings
...
>       iio: imu: st_lsm6dsx: check if shub_output reg is located in primar=
y page
>       iio: imu: st_lsm6dsx: rename st_lsm6dsx_shub_read_reg in st_lsm6dsx=
_shub_read_output
...
>=20
> Matt Ranostay (1):
>       iio: chemical: atlas-ph-sensor: rename atlas-ph-sensor to atlas-sen=
sor
>=20
> Olivier Moysan (1):
...
>=20
> Peter Ujfalusi (1):
>       iio: buffer-dmaengine: Use dma_request_chan() directly for channel =
request
>=20
> Rodrigo Carvalho (2):
...
>       iio: adc: ltc2497: split protocol independent part in a separate mo=
dule
...
>  create mode 100644 Documentation/devicetree/bindings/iio/accel/adi,adis1=
6240.yaml
>  create mode 100644 Documentation/devicetree/bindings/iio/accel/bosch,bma=
400.yaml
...
6.yaml
>  delete mode 100644 Documentation/devicetree/bindings/iio/adc/sigma-delta=
-modulator.txt
>  create mode 100644 Documentation/devicetree/bindings/iio/adc/sigma-delta=
-modulator.yaml
>  create mode 100644 Documentation/devicetree/bindings/iio/pressure/asc,dl=
hl60d.yaml
>  create mode 100644 Documentation/devicetree/bindings/iio/proximity/paral=
lax-ping.yaml
