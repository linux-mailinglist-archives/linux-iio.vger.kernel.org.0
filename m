Return-Path: <linux-iio+bounces-720-lists+linux-iio=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-iio@lfdr.de
Delivered-To: lists+linux-iio@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 41DBB808DBF
	for <lists+linux-iio@lfdr.de>; Thu,  7 Dec 2023 17:48:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9B324B20DE6
	for <lists+linux-iio@lfdr.de>; Thu,  7 Dec 2023 16:48:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2D26347F46;
	Thu,  7 Dec 2023 16:47:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=subdimension.ro header.i=@subdimension.ro header.b="Y7PMdGbK"
X-Original-To: linux-iio@vger.kernel.org
Received: from mail.subdimension.ro (unknown [IPv6:2a01:7e01:e001:1d1::2])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1FBC91701;
	Thu,  7 Dec 2023 08:47:50 -0800 (PST)
Received: from localhost.localdomain (unknown [188.24.94.216])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.subdimension.ro (Postfix) with ESMTPSA id 550B328F040;
	Thu,  7 Dec 2023 16:47:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=subdimension.ro;
	s=skycaves; t=1701967668;
	bh=xAtVnpubTE4g4fAuN9JOGagkm0baVPen1aP9J9Cx83A=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References;
	b=Y7PMdGbKvqpFSdSuuiirRB+D+NVV2SXsvbR5uVNky3/Yn785c+X9qcQdwnF/rTX+m
	 h3vLbCfaAuwz5vvIf4ymKcVzDiEL6damaOj9yQE2ZZlGCjVFmAYn7Uur0xVA9mD9Ml
	 Gh0gTZoMJiAajEm8GI1/nzweTTVeF1I07SmZ5nQ8=
...
Subject: [PATCH v8 2/2] iio: pressure: driver for Honeywell HSC/SSC series
Date: Thu,  7 Dec 2023 18:46:29 +0200
Message-ID: <20231207164634.11998-2-petre.rodan@subdimension.ro>
X-Mailer: git-send-email 2.41.0
In-Reply-To: <20231207164634.11998-1-petre.rodan@subdimension.ro>
...
v7: modifications based on Jonathan's review
    - hardcode iio_dev->name
    - pass struct device between common and bus drivers instead of
      bus client
v8: match_string() replaced by device_property_match_property_string()
---
 MAINTAINERS                         |   7 +
...
index 1338e1176ea5..77cb44a51369 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
