...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6DBD5590667
	for <lists+linux-iio@lfdr.de>; Thu, 11 Aug 2022 20:47:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235868AbiHKSnz (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Thu, 11 Aug 2022 14:43:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52470 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235855AbiHKSny (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Thu, 11 Aug 2022 14:43:54 -0400
Received: from mout.gmx.net (mout.gmx.net [212.227.17.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CBD8897D65
        for <linux-iio@vger.kernel.org>; Thu, 11 Aug 2022 11:43:50 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1660243420;
        bh=gbvusj7PgyHJd60mOiV6keaoKNXsf2rJZwU1eHMkIAU=;
        h=X-UI-Sender-Class:From:To:Cc:Subject:Date;
        b=OdI3jacstSKrBGnygZUqoH3ka4Q9Oe6YLUjpaJNPfEfWKeJeEzY8waw9KNHw6oUON
         Lb7lxWMuZZFcGPEyrxt/fR1By8Sh1qIU7cd5M6yztEBDrjxc9u5867YRrF0d5mpwab
         MRSTtSmLJWnlozK6n+DJWkMgDGxSojWMB5ptrYoI=
...
Received: from [93.238.92.22] ([93.238.92.22]) by web-mail.gmx.net
 ...
 20:43:39 +0200
MIME-Version: 1.0
Message-ID: <trinity-22d7d0e8-17b9-4b9b-a299-702c061ce8b8-1660243419946@3c-app-gmx-bs58>
From:   Philipp Jungkamp <p.jungkamp@gmx.net>
To:     Jiri Kosina <jikos@kernel.org>,
        Jonathan Cameron <jic23@kernel.org>,
        Srinivas Pandruvada <srinivas.pandruvada@linux.intel.com>
Cc:     linux-iio@vger.kernel.org
Subject: PROBLEM: Some intel-ish/hid-sensor-hub IIO devices always report 0
 on synchronous read
Content-Type: text/plain; charset=UTF-8
Date:   Thu, 11 Aug 2022 20:43:39 +0200
Importance: normal
Sensitivity: Normal
X-Priority: 3
X-Provags-ID: V03:K1:
X-UI-Out-Filterresults: notjunk:1;V03:K0:qPlu/hpzuBo=:bUZMASwmjpUI83dzxVO9YL
 
 eg5zb1g
...
Some intel-ish/hid-sensor-hub IIO devices always report 0 on synchronous read

[2.] Full description of the problem/report:
Reading from some of the IIO sensor devices using the sysfs attributes does
almost always report 0. This occurs on custom sensor drivers like
hid-sensor-custom-intel-hinge or hid-sensor-custom. The Lenovo Yoga 9 14IAP7
has several custom sensors, among them the intel hinge, an ambient light
sensor, human presence detection and similar which are affected.
But enabling the IIO buffer on the hinge or using the enable_sensor sysfs
...
$ echo 1 | tee /sys/bus/iio/devices/iio:device1/buffer0/{in_angl0_en,enable}
1
...
$ cat /dev/iio:device1
}}||yyvvuussqqppmmllkkjjhijikkllkkllmmnnpprrppoooppppopppopppopppopppopp
...
MaxPayload 128 bytes, MaxReadReq 128 bytes
DevSta: CorrErr- NonFatalErr- FatalErr- UnsupReq- AuxPwr+ TransPend-
LnkCap: Port #3, Speed 2.5GT/s, Width x4, ASPM L1, Exit Latency L1 <16us
ClockPM- Surprise- LLActRep+ BwNot+ ASPMOptComp+
LnkCtl: ASPM L1 Enabled; RCB 64 bytes, Disabled- CommClk-
ExtSynch- ClockPM- AutWidDis- BWInt- AutBWInt-
LnkSta: Speed 2.5GT/s, Width x0
...
00:12.0 Serial controller: Intel Corporation Device 51fc (rev 01) (prog-if 00 [8250])
Subsystem: Intel Corporation Device 7270
Control: I/O- Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop- ParErr- Stepping- SERR- FastB2B- DisINTx-
Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort- <TAbort- <MAbort- >SERR- <PERR- INTx-
Latency: 0, Cache Line Size: 64 bytes
...
I suspect that the sensor hub does not answer sync read requests accurately.
I didn't find any report of a similar issue so I'm asking here and hope that I
