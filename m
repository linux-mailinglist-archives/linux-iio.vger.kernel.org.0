...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AA2FE1ADA6F
	for <lists+linux-iio@lfdr.de>; Fri, 17 Apr 2020 11:51:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726557AbgDQJvj (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Fri, 17 Apr 2020 05:51:39 -0400
Received: from gproxy6-pub.mail.unifiedlayer.com ([67.222.39.168]:47091 "EHLO
        gproxy6-pub.mail.unifiedlayer.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725830AbgDQJvi (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Fri, 17 Apr 2020 05:51:38 -0400
X-Greylist: delayed 1325 seconds by postgrey-1.27 at vger.kernel.org; Fri, 17 Apr 2020 05:51:34 EDT
Received: from CMGW (unknown [10.9.0.13])
        by gproxy6.mail.unifiedlayer.com (Postfix) with ESMTP id D3D511E096F
        for <linux-iio@vger.kernel.org>; Fri, 17 Apr 2020 03:29:26 -0600 (MDT)
Received: from md-in-79.webhostbox.net ([43.225.55.182])
        by cmsmtp with ESMTP
        id PNJMjPcqOtoKZPNJNj3OWU; Fri, 17 Apr 2020 03:29:26 -0600
...
X-Authority-Analysis: v=2.2 cv=AaTBJzfG c=1 sm=1 tr=0
 ...
 a=Q80MQAUPVNzE_VpuHZcA:9 a=Tr0RDmfiFe8SCtAM:21 a=IOQC4ytgWhHxycDD:21
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=linumiz.com
        ...
        bh=D2ZPiLhDuS+ffpZFJeR7EWpRpQcxZ5PL5/2Z5yFjNrQ=; b=N3l7trhEDqDxn6EN+0K4x7kKMT
        ;
Received: from p5b3f7443.dip0.t-ipconnect.de ([91.63.116.67]:54288 helo=[192.168.0.104])
        by md-in-79.webhostbox.net with esmtpsa (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128)
        (Exim 4.92)
        (envelope-from <saravanan@linumiz.com>)
        id 1jPNJK-0004eF-WD; Fri, 17 Apr 2020 09:29:23 +0000
...
References: <20200415065535.7753-1-saravanan@linumiz.com>
 ...
 <alpine.DEB.2.21.2004151117280.22614@vps.pmeerw.net>
From:   Saravanan Sekar <saravanan@linumiz.com>
Message-ID: <9dc911d1-3258-dd5f-6546-e6300b6864dc@linumiz.com>
Date:   Fri, 17 Apr 2020 11:29:19 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.7.0
MIME-Version: 1.0
In-Reply-To: <alpine.DEB.2.21.2004151117280.22614@vps.pmeerw.net>
...
X-BWhitelist: no
X-Source-IP: 91.63.116.67
X-Source-L: No
X-Exim-ID: 1jPNJK-0004eF-WD
X-Source: 
X-Source-Args: 
X-Source-Dir: 
X-Source-Sender: p5b3f7443.dip0.t-ipconnect.de ([192.168.0.104]) [91.63.116.67]:54288
...
On 15/04/20 11:41 am, Peter Meerwald-Stadler wrote:
...
The formula to convert from raw value  is (raw/16.0 + 25).

=> (0.0625 * raw + 25) => 625 * raw + 25000
625 * raw -> raw above
25000 -> offset
100 -> scale to IIO_VAL_INT_PLUS_MICRO.

Hope the explanation above convinced you, I'm open to any other better way.
I will consider rest of comments for next revision.
