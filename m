...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4A25E4CA636
	for <lists+linux-iio@lfdr.de>; Wed,  2 Mar 2022 14:43:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242318AbiCBNoi (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Wed, 2 Mar 2022 08:44:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47498 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236210AbiCBNoh (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Wed, 2 Mar 2022 08:44:37 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A29BA396BC
        for <linux-iio@vger.kernel.org>; Wed,  2 Mar 2022 05:43:52 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 1F62760AD0
        for <linux-iio@vger.kernel.org>; Wed,  2 Mar 2022 13:43:52 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 6FEC3C004E1;
        Wed,  2 Mar 2022 13:43:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1646228631;
        bh=q4goUTIpbAkhPvpRr5bC4tPgsVe4H+mqFp0Bu8qYuEI=;
        h=Date:From:To:Subject:From;
        b=
Date:   Wed, 2 Mar 2022 13:51:01 +0000
From:   Jonathan Cameron <jic23@kernel.org>
To:     gregkh@linuxfoundation.org, linux-iio@vger.kernel.org
Subject: [PULL] IIO new device support, features, fixes and cleanups for
 5.18
Message-ID: <20220302135101.353b9470@jic23-huawei>
...
for you to fetch changes up to 0bf126163c3e7e6d722622073046aed567a5551e:
  ...
  iio: adc: xilinx-ams: Fix single channel switching sequence (2022-03-02 1=
3:39:08 +0000)

----------------------------------------------------------------
First set of new device support, fixes, cleanups and features for IIO in 5.=
18
...
* st_sensors
  - Allow manual disabling of I2C or SPI module if not needed for a particu=
lar
...
Andy Shevchenko (25):
      ...
      iio: temperature: mlx90632: Switch from of headers to mod_devicetable=
.h
      iio: temperature: maxim_thermocouple: Switch from of headers to mod_d=
evicetable.h
      iio: accel: adxl355: Replace custom definitions with generic from uni=
ts.h
...
Christophe JAILLET (2):
      ...
      iio: adc: xilinx-ams: Use devm_delayed_work_autocancel() to simplify =
code

Colin Ian King (1):
      iio: adc: cpcap-adc: remove redundant assignment to variable cal_data=
_diff
...
Eugen Hristev (1):
      dt-bindings: iio: adc: atmel,sama5d2-adc: make atmel,trigger-edge-typ=
e non-mandatory
...
{ and before }
      ...
      iio:light:us5182: White space cleanup of spacing around {} in id tabl=
es
      iio:light:ltr501: White space cleanup of spacing around {} in id tabl=
es
      iio:proximity:ping: White space cleanup of spacing around {} in id ta=
bles
      iio:proximity:rfd77402: White space cleanup of spacing around {} in i=
d tables
      iio:proximity:srf04: White space cleanup of spacing around {} in id t=
ables
      iio:proximity:srf08: White space cleanup of spacing around {} in id t=
ables
      iio:frequency:admv1013: White space cleanup of spacing around {} in i=
d tables
 ...
 etc
      iio:accel:dmard06: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
...
()
      ...
      iio:accel:stk8ba50: Switch from CONFIG_PM_SLEEP guards to pm_sleep_pt=
r() etc
      iio:adc:at91-adc: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr(=
) etc
      iio:adc:exynos_adc: Switch from CONFIG_PM_SLEEP guards to pm_sleep_pt=
r()
      iio:adc:palmas_gpadc: Switch from CONFIG_PM_SLEEP guards to pm_sleep_=
ptr()
 ...
 etc
      iio:adc:vf610: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr() e=
tc
      iio:common:ssp: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr() =
etc
      iio:dac:vf610: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr() e=
tc
      iio:light:apds9300: Switch from CONFIG_PM_SLEEP guards to pm_sleep_pt=
r() etc
      iio:light:cm3232: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr(=
) etc
      iio:light:isl29018: Switch from CONFIG_PM_SLEEP guards to pm_sleep_pt=
r()
      iio:light:isl29125: Switch from CONFIG_PM_SLEEP guards to pm_sleep_pt=
r() etc
      iio:light:jsa1212: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:light:ltr501: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr(=
) etc
      iio:light:stk3310: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:light:tcs3414: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:light:tcs3472: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:light:tsl2563: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:light:tsl4531: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      ...
      iio:magn:mmc35240: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
      iio:pressure:mpl3115: Switch from CONFIG_PM_SLEEP guards to pm_sleep_=
ptr() etc
      iio:proximity:as3935: Switch from CONFIG_PM_SLEEP guards to pm_sleep_=
ptr() etc
      iio:proximity:rfd77492: Switch from CONFIG_PM_SLEEP guards to pm_slee=
p_ptr() etc
      iio:proximity:sx9500: Switch from CONFIG_PM_SLEEP guards to pm_sleep_=
ptr() etc
      iio:temperature:tmp006: Switch from CONFIG_PM_SLEEP guards to pm_slee=
p_ptr() etc
      iio:temperature:tmp007: Switch from CONFIG_PM_SLEEP guards to pm_slee=
p_ptr() etc
      iio:accel:stk8312: Switch from CONFIG_PM_SLEEP guards to pm_sleep_ptr=
() etc
...
etc
      ...
      iio:temperature:mlx90614: Switch from CONFIG_PM* guards to pm_ptr() e=
tc
      ...
      iio:proximity:pulsedlight: Switch from CONFIG_PM guards to pm_ptr() e=
tc
      ...
      iio:adc:stm32*: Use pm[_sleep]_ptr() etc to avoid need to make pm __m=
aybe_unused
      ...
      staging:iio:adc:ad7280a: Use bitfield ops to managed fields in transf=
ers.
      ...
      staging:iio:adc:ad7280a: Use device properties to replace platform da=
ta.
...
AUX alert.
      ...
      staging:iio:adc:ad7280a: Use more conservative delays to allow 105C o=
peration.
...
Nathan Chancellor (1):
      iio: accel: adxl367: Fix handled initialization in adxl367_irq_handle=
r()
...
Nikita Yushchenko (1):
      iio: st_sensors: don't always auto-enable I2C and SPI interface drive=
rs
...
Rob Herring (2):
      dt-bindings: iio/adc: ti,palmas-gpadc: Split interrupt fields in exam=
ple
...
++++
 ...
 create mode 100644 Documentation/ABI/testing/sysfs-bus-iio-frequency-admv1=
014
 create mode 100644 Documentation/ABI/testing/sysfs-bus-iio-sx9324
 create mode 100644 Documentation/devicetree/bindings/iio/accel/adi,adxl367=
.yaml
 create mode 100644 Documentation/devicetree/bindings/iio/adc/adi,ad7280a.y=
aml
 create mode 100644 Documentation/devicetree/bindings/iio/afe/temperature-s=
ense-rtd.yaml
 create mode 100644 Documentation/devicetree/bindings/iio/afe/temperature-t=
ransducer.yaml
 create mode 100644 Documentation/devicetree/bindings/iio/amplifiers/adi,ad=
a4250.yaml
 create mode 100644 Documentation/devicetree/bindings/iio/dac/adi,ltc2688.y=
aml
