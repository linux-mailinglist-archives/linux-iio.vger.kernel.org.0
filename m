...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8F20F4542DF
	for <lists+linux-iio@lfdr.de>; Wed, 17 Nov 2021 09:47:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233816AbhKQIth (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Wed, 17 Nov 2021 03:49:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34366 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233761AbhKQItg (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Wed, 17 Nov 2021 03:49:36 -0500
Received: from mail-pg1-x530.google.com (mail-pg1-x530.google.com [IPv6:2607:f8b0:4864:20::530])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 63D5BC061570
        for <linux-iio@vger.kernel.org>; Wed, 17 Nov 2021 00:46:38 -0800 (PST)
Received: by mail-pg1-x530.google.com with SMTP id 188so1640561pgb.7
        for <linux-iio@vger.kernel.org>; Wed, 17 Nov 2021 00:46:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Dk0MiGpxDoLBLigLVfVA3jWAes1O6Ld1exLWEsgybjc=;
        b=P1/ckmJpv+/ZVE96xOwXh2imX/NX5P0JjNhl0qMYC7a51s3XtItosSSqipbY+bVGm/
         z/dvhwzUqGKE5TL1Eb42UB9JJ76hb2XxTN9Jo4DSQkT4nbhFY6sMeiKHh99wv25fzERD
         Gh8jI24ynUpS6wzHcUkAoPVO+ioy1gl7KxJKA=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=Dk0MiGpxDoLBLigLVfVA3jWAes1O6Ld1exLWEsgybjc=;
        b=
X-Gm-Message-State: AOAM530ZgVAOaNr62+xN7KGHSSEQcB+eyKJdGUlb6szyoGOLCW+XDefn
        CSzSu/3C/7FjxsL8OF1XZPZFr18/TPjr5Q==
X-Google-Smtp-Source: ABdhPJy1w3Rx0rlFbPlDemVrKemY1x9FaJ9zDyVR+tZhquke5prwrswOra8QjrxlmoWJMPNB5Lvy4A==
X-Received: by 2002:a05:6a00:1305:b0:4a2:75cd:883b with SMTP id j5-20020a056a00130500b004a275cd883bmr36281349pfu.44.1637138797630;
        Wed, 17 Nov 2021 00:46:37 -0800 (PST)
Received: from localhost ([2620:15c:202:201:327f:7baa:380e:33a3])
        by smtp.gmail.com with UTF8SMTPSA id na13sm5230209pjb.11.2021.11.17.00.46.36
...
Subject: [PATCH v3 2/5] iio: sx9310: Extract common Semtech sensor logic
Date:   Wed, 17 Nov 2021 00:46:28 -0800
Message-Id: <20211117084631.2820014-3-gwendal@chromium.org>
...
@@ -306,64 +255,7 @@ static const struct regmap_config sx9310_regmap_config = {
...
+static int sx9310_read_prox_data(struct sx_common_data *data,
 ...
 {
 	int ret;
@@ -379,7 +271,7 @@ static int sx9310_read_prox_data(struct sx9310_data *data,
...
+static int sx9310_wait_for_sample(struct sx_common_data *data)
 {
 	int ret;
 	unsigned int val;
@@ -395,66 +287,7 @@ static int sx9310_wait_for_sample(struct sx9310_data *data)
 	return 0;
 }
...
@@ -482,7 +315,7 @@ static int sx9310_read_gain(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_samp_freq(struct sx_common_data *data, int *val, int *val2)
 {
 	unsigned int regval;
 	int ret;
@@ -502,7 +335,7 @@ static int sx9310_read_raw(struct iio_dev *indio_dev,
 			   const struct iio_chan_spec *chan, int *val,
 			   int *val2, long mask)
 {
...
@@ -514,7 +347,7 @@ static int sx9310_read_raw(struct iio_dev *indio_dev,
 		if (ret)
 			return ret;
...
@@ -577,7 +410,7 @@ static int sx9310_get_thresh_reg(unsigned int channel)
 	return -EINVAL;
 }
...
+static int sx9310_read_thresh(struct sx_common_data *data,
 ...
 {
 	unsigned int reg;
@@ -600,7 +433,7 @@ static int sx9310_read_thresh(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
@@ -624,7 +457,7 @@ static int sx9310_read_hysteresis(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_far_debounce(struct sx_common_data *data, int *val)
 {
 	unsigned int regval;
 	int ret;
@@ -642,7 +475,7 @@ static int sx9310_read_far_debounce(struct sx9310_data *data, int *val)
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_close_debounce(struct sx_common_data *data, int *val)
 {
 	unsigned int regval;
 	int ret;
@@ -666,7 +499,7 @@ static int sx9310_read_event_val(struct iio_dev *indio_dev,
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -690,7 +523,7 @@ static int sx9310_read_event_val(struct iio_dev *indio_dev,
 	}
 }
...
+static int sx9310_write_thresh(struct sx_common_data *data,
 ...
 {
 	unsigned int reg;
@@ -720,7 +553,7 @@ static int sx9310_write_thresh(struct sx9310_data *data,
 	return ret;
 }
...
@@ -750,7 +583,7 @@ static int sx9310_write_hysteresis(struct sx9310_data *data,
 	return ret;
 }
...
+static int sx9310_write_far_debounce(struct sx_common_data *data, int val)
 {
 	int ret;
 	unsigned int regval;
@@ -771,7 +604,7 @@ static int sx9310_write_far_debounce(struct sx9310_data *data, int val)
 	return ret;
 }
...
+static int sx9310_write_close_debounce(struct sx_common_data *data, int val)
 {
 	int ret;
 	unsigned int regval;
@@ -798,7 +631,7 @@ static int sx9310_write_event_val(struct iio_dev *indio_dev,
 				  enum iio_event_direction dir,
 				  enum iio_event_info info, int val, int val2)
 {
-	struct sx9310_data *data = iio_priv(indio_dev);
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -822,7 +655,7 @@ static int sx9310_write_event_val(struct iio_dev *indio_dev,
 	}
 }
...
@@ -846,8 +679,8 @@ static int sx9310_set_samp_freq(struct sx9310_data *data, int val, int val2)
 	return ret;
 }
...
+			     const struct iio_chan_spec *chan, int val)
 {
 	...
 	int ret;
@@ -881,7 +714,7 @@ static int sx9310_write_raw(struct iio_dev *indio_dev,
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -896,238 +729,7 @@ static int sx9310_write_raw(struct iio_dev *indio_dev,
 	return -EINVAL;
 }
...
+static const struct sx_common_reg_default sx9310_default_regs[] = {
 	...
 	/*
@@ -1172,7 +774,7 @@ static const struct sx9310_reg_default sx9310_default_regs[] = {
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	unsigned int val;
 	unsigned int ctrl0;
@@ -1202,9 +804,9 @@ static int sx9310_init_compensation(struct iio_dev *indio_dev)
 	return ret;
 }
...
@@ -1305,42 +907,20 @@ sx9310_get_default_reg(struct device *dev, int idx,
 	return reg_def;
 }
...
@@ -1362,108 +942,47 @@ static int sx9310_set_indio_dev_name(struct device *dev,
 	return 0;
 }
...
@@ -1471,11 +990,11 @@ static int __maybe_unused sx9310_suspend(struct device *dev)
