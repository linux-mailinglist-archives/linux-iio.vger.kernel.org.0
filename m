...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9960D4797BF
	for <lists+linux-iio@lfdr.de>; Sat, 18 Dec 2021 01:18:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229904AbhLRASE (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Fri, 17 Dec 2021 19:18:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37886 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229643AbhLRASD (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Fri, 17 Dec 2021 19:18:03 -0500
Received: from mail-pj1-x1034.google.com (mail-pj1-x1034.google.com [IPv6:2607:f8b0:4864:20::1034])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75E6CC06173E
        for <linux-iio@vger.kernel.org>; Fri, 17 Dec 2021 16:18:03 -0800 (PST)
Received: by mail-pj1-x1034.google.com with SMTP id n15-20020a17090a160f00b001a75089daa3so7134647pja.1
        for <linux-iio@vger.kernel.org>; Fri, 17 Dec 2021 16:18:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=XzZNZVQ2IA5vX4PcH0XKMh+AHmVqdMvZHgnoPrDTkkw=;
        b=asY17BxYP/T26sPj21X0JY/FyC9ek5Qe0I5z/HAXEKGgwV2sgpqKnxkh9VOHAfW8c6
         cnsRv4TNLzknGHeZXf9VUUEIbBXQ5O2frmTt/31TesLYRcFZnnK4TUpker4nPfCr8e/K
         RZMBzc6G7CPqssNwgPUv6hJ1JPvDf4K9l8d6Y=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=XzZNZVQ2IA5vX4PcH0XKMh+AHmVqdMvZHgnoPrDTkkw=;
        b=
X-Gm-Message-State: AOAM531QyVm419a+8tHWk7OL263B+9/eOczOGqdI4I11v3nqFlhU4c0e
        6OM7qbhnnWYmo2qx15oqlk0asA==
X-Google-Smtp-Source: ABdhPJzxBlNqiAIUa540Nb+/hTXxZeu04jdghLeNnmEP3Pow9sIJypFezQ2R5UOZ4LXDy/dEBAYP5A==
X-Received: by 2002:a17:90b:f0b:: with SMTP id br11mr2635104pjb.39.1639786682522;
        Fri, 17 Dec 2021 16:18:02 -0800 (PST)
Received: from localhost ([2620:15c:202:201:2bc8:cefc:f407:829])
        by smtp.gmail.com with UTF8SMTPSA id m11sm10930270pfk.27.2021.12.17.16.18.01
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 17 Dec 2021 16:18:02 -0800 (PST)
From:   Gwendal Grignou <gwendal@chromium.org>
To:     jic23@kernel.org, lars@metafoo.de, swboyd@chromium.org
Cc:     linux-iio@vger.kernel.org, Gwendal Grignou <gwendal@chromium.org>
Subject: [PATCH v8 2/5] iio: sx9310: Extract common Semtech sensor logic
Date:   Fri, 17 Dec 2021 16:17:52 -0800
Message-Id: <20211218001755.3096807-3-gwendal@chromium.org>
...
- Fix kernel doc comments.
 ...
 drivers/iio/proximity/sx9310.c    | 688 +++++-------------------------
 drivers/iio/proximity/sx_common.c | 576 +++++++++++++++++++++++++
 drivers/iio/proximity/sx_common.h | 163 +++++++
 5 files changed, 844 insertions(+), 590 deletions(-)
...
index 1647268b6471f1..fe160702ffae47 100644
...
@@ -1355,115 +927,52 @@ static int sx9310_set_indio_dev_name(struct device *dev,
...
@@ -1471,11 +980,11 @@ static int __maybe_unused sx9310_suspend(struct device *dev)
...
+	ctrl0 = data->suspend_ctrl & ~SX9310_REG_PROX_CTRL0_SENSOREN_MASK;
 	...
 	if (ret)
 		goto out;
@@ -1489,8 +998,7 @@ static int __maybe_unused sx9310_suspend(struct device *dev)
...
+	struct sx_common_data *data = iio_priv(dev_get_drvdata(dev));
 	...
 	mutex_lock(&data->mutex);
@@ -1499,7 +1007,7 @@ static int __maybe_unused sx9310_resume(struct device *dev)
 		goto out;
