...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AD4EA457CCE
	for <lists+linux-iio@lfdr.de>; Sat, 20 Nov 2021 11:15:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231133AbhKTKSP (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Sat, 20 Nov 2021 05:18:15 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40218 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237264AbhKTKSO (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Sat, 20 Nov 2021 05:18:14 -0500
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 157BFC061574
        for <linux-iio@vger.kernel.org>; Sat, 20 Nov 2021 02:15:11 -0800 (PST)
Received: by mail-pj1-x1029.google.com with SMTP id gt5so9824682pjb.1
        for <linux-iio@vger.kernel.org>; Sat, 20 Nov 2021 02:15:11 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Hvp1Rz5UopbwULqXU1QnshEVTU00DgUgRSXfBG3y9Ls=;
        b=HFsh3AGpSmtfI6vyP15BBUOUS4z6ZL+rY4IUSXb9pgAKUrzsknHjfYIwCDrq+hWrmA
         //wYNHISdKmmJt+RwX0biO2N7qzR2bKJId1zdjwK+oBAgrsEVeeI0rmL43g2zJiwUJKE
         1veoKEnKStZIxRQS/5z6NkB06vfLbDrrrDlDc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=Hvp1Rz5UopbwULqXU1QnshEVTU00DgUgRSXfBG3y9Ls=;
        b=
X-Gm-Message-State: AOAM530xc0zM2PRJQs+z52Q/L1pu+GpKGYo4iKXR5DZ2C0JksTi0ILIB
        VyXcm/DpJLfJpN2RFE6IoDCpGA==
X-Google-Smtp-Source: ABdhPJykIY5uMVEAI9Ni3+VHaipBknh9spWnRPveFsKlN4r3GT8hRMtjYux/lNo/xrCgmQ2ngo/FWA==
X-Received: by 2002:a17:90b:1812:: with SMTP id lw18mr8908546pjb.196.1637403310011;
        Sat, 20 Nov 2021 02:15:10 -0800 (PST)
Received: from localhost ([2620:15c:202:201:913f:8f64:e1fa:a751])
        by smtp.gmail.com with UTF8SMTPSA id z10sm2479551pfh.106.2021.11.20.02.15.09
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sat, 20 Nov 2021 02:15:09 -0800 (PST)
From:   Gwendal Grignou <gwendal@chromium.org>
To:     jic23@kernel.org, lars@metafoo.de, swboyd@chromium.org
Cc:     andy.shevchenko@gmail.com, linux-iio@vger.kernel.org,
        Gwendal Grignou <gwendal@chromium.org>
Subject: [PATCH v4 2/5] iio: sx9310: Extract common Semtech sensor logic
Date:   Sat, 20 Nov 2021 02:14:58 -0800
Message-Id: <20211120101501.1659549-3-gwendal@chromium.org>
...
@@ -306,64 +257,7 @@ static const struct regmap_config sx9310_regmap_config = {
...
+static int sx9310_read_prox_data(struct sx_common_data *data,
 ...
 {
 	int ret;
@@ -379,7 +273,7 @@ static int sx9310_read_prox_data(struct sx9310_data *data,
...
+static int sx9310_wait_for_sample(struct sx_common_data *data)
 {
 	int ret;
 	unsigned int val;
@@ -395,66 +289,7 @@ static int sx9310_wait_for_sample(struct sx9310_data *data)
 	return 0;
 }
...
@@ -482,7 +317,7 @@ static int sx9310_read_gain(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_samp_freq(struct sx_common_data *data, int *val, int *val2)
 {
 	unsigned int regval;
 	int ret;
@@ -502,7 +337,7 @@ static int sx9310_read_raw(struct iio_dev *indio_dev,
 			   const struct iio_chan_spec *chan, int *val,
 			   int *val2, long mask)
 {
...
@@ -514,7 +349,7 @@ static int sx9310_read_raw(struct iio_dev *indio_dev,
 		if (ret)
 			return ret;
...
@@ -577,7 +412,7 @@ static int sx9310_get_thresh_reg(unsigned int channel)
 	return -EINVAL;
 }
...
+static int sx9310_read_thresh(struct sx_common_data *data,
 ...
 {
 	unsigned int reg;
@@ -600,7 +435,7 @@ static int sx9310_read_thresh(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
@@ -624,7 +459,7 @@ static int sx9310_read_hysteresis(struct sx9310_data *data,
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_far_debounce(struct sx_common_data *data, int *val)
 {
 	unsigned int regval;
 	int ret;
@@ -642,7 +477,7 @@ static int sx9310_read_far_debounce(struct sx9310_data *data, int *val)
 	return IIO_VAL_INT;
 }
...
+static int sx9310_read_close_debounce(struct sx_common_data *data, int *val)
 {
 	unsigned int regval;
 	int ret;
@@ -666,7 +501,7 @@ static int sx9310_read_event_val(struct iio_dev *indio_dev,
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -690,7 +525,7 @@ static int sx9310_read_event_val(struct iio_dev *indio_dev,
 	}
 }
...
+static int sx9310_write_thresh(struct sx_common_data *data,
 ...
 {
 	unsigned int reg;
@@ -720,7 +555,7 @@ static int sx9310_write_thresh(struct sx9310_data *data,
 	return ret;
 }
...
@@ -750,7 +585,7 @@ static int sx9310_write_hysteresis(struct sx9310_data *data,
 	return ret;
 }
...
+static int sx9310_write_far_debounce(struct sx_common_data *data, int val)
 {
 	int ret;
 	unsigned int regval;
@@ -771,7 +606,7 @@ static int sx9310_write_far_debounce(struct sx9310_data *data, int val)
 	return ret;
 }
...
+static int sx9310_write_close_debounce(struct sx_common_data *data, int val)
 {
 	int ret;
 	unsigned int regval;
@@ -798,7 +633,7 @@ static int sx9310_write_event_val(struct iio_dev *indio_dev,
 				  enum iio_event_direction dir,
 				  enum iio_event_info info, int val, int val2)
 {
-	struct sx9310_data *data = iio_priv(indio_dev);
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -822,7 +657,7 @@ static int sx9310_write_event_val(struct iio_dev *indio_dev,
 	}
 }
...
@@ -846,8 +681,8 @@ static int sx9310_set_samp_freq(struct sx9310_data *data, int val, int val2)
 	return ret;
 }
...
+			     const struct iio_chan_spec *chan, int val)
 {
 	...
 	int ret;
@@ -881,7 +716,7 @@ static int sx9310_write_raw(struct iio_dev *indio_dev,
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	if (chan->type != IIO_PROXIMITY)
 		return -EINVAL;
@@ -896,238 +731,7 @@ static int sx9310_write_raw(struct iio_dev *indio_dev,
 	return -EINVAL;
 }
...
+static const struct sx_common_reg_default sx9310_default_regs[] = {
 	...
 	/*
@@ -1172,7 +776,7 @@ static const struct sx9310_reg_default sx9310_default_regs[] = {
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	unsigned int val;
 	unsigned int ctrl0;
@@ -1202,9 +806,9 @@ static int sx9310_init_compensation(struct iio_dev *indio_dev)
 	return ret;
 }
...
@@ -1305,42 +909,20 @@ sx9310_get_default_reg(struct device *dev, int idx,
 	return reg_def;
 }
...
@@ -1362,108 +944,47 @@ static int sx9310_set_indio_dev_name(struct device *dev,
 	return 0;
 }
...
@@ -1471,11 +992,11 @@ static int __maybe_unused sx9310_suspend(struct device *dev)
...
+	ctrl0 = data->suspend_ctrl & ~SX9310_REG_PROX_CTRL0_SENSOREN_MASK;
 	...
 	if (ret)
 		goto out;
@@ -1490,7 +1011,7 @@ static int __maybe_unused sx9310_suspend(struct device *dev)
...
+	struct sx_common_data *data = iio_priv(indio_dev);
 	...
 	mutex_lock(&data->mutex);
@@ -1499,7 +1020,7 @@ static int __maybe_unused sx9310_resume(struct device *dev)
 		goto out;
