Return-Path: <linux-iio+bounces-19777-lists+linux-iio=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-iio@lfdr.de
Delivered-To: lists+linux-iio@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 964C7ABF622
	for <lists+linux-iio@lfdr.de>; Wed, 21 May 2025 15:32:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D0C273AA298
	for <lists+linux-iio@lfdr.de>; Wed, 21 May 2025 13:31:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4175026560A;
	Wed, 21 May 2025 13:32:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="B6Q7Ctau"
X-Original-To: linux-iio@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E223938F80
	for <linux-iio@vger.kernel.org>; Wed, 21 May 2025 13:32:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747834324; cv=none; b=rdDwyofmwIFVW8MZ8kgvNdI7tT1gwexohI2gJv2IXd1RDyn1cTkEjDgTFfEZzSPMYIC7Og/20DZhB372PsNZC4ywTno26+BNZFVGUIrG0hpALbzs35HjFs9mzW5vGl0lr9jzhWYo2E0xizsSC7iVW5+QHXMo2zAhZwJHeQQYZ24=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747834324; c=relaxed/simple;
	bh=W9Ax+O7guNHXt+SmGboBkVHqTKSpXsmPhxv/454FtJg=;
	h=Date:From:To:Subject:Message-ID:MIME-Version:Content-Type; b=CCoWzkzv/XV+1rphxcvBkgWF7xQWDnWMdAvXdqtyROnDkJ8Pr5lv2DRGgK3abIpk/YIMG6BrRPrKfIPDG7Gg5DDwPKuZx+++vDmbhGaCB3xdBfNUv2BkQWEwTqHpX2DfhByrWDZFXSJ5zUZGe9rWiiOiEXP6o34z1R4s6Wflcm4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=B6Q7Ctau; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 97EB3C4CEE4;
	Wed, 21 May 2025 13:32:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1747834323;
	bh=W9Ax+O7guNHXt+SmGboBkVHqTKSpXsmPhxv/454FtJg=;
	h=Date:From:To:Subject:From;
	b=
Date: Wed, 21 May 2025 14:31:59 +0100
From: Jonathan Cameron <jic23@kernel.org>
To: gregkh@linuxfoundation.org, linux-iio@vger.kernel.org
Subject: [PULL v2] IIO: New device support, features and cleanup for 6.16
Message-ID: <20250521143159.097d9b52@jic23-huawei>
...
for you to fetch changes up to 0c86e33819785fe50616b6ee3fb35c1e4be406d5:

  dt-bindings: iio: adc: Add ROHM BD79100G (2025-05-21 14:22:33 +0100)
...
- Enable use of named interrupts to avoid problems with some wiring choices.
  Get the interrupt by name, but fallback to previous assumption on the fir=
st
...
Chelsy Ratnawat (2):
      HID: sensor-hub: Fix typo and improve documentation for sensor_hub_re=
move_callback()
...
David Heidelberg (13):
      ...
      iio: light: al3010: Improve al3010_init error handling with dev_err_p=
robe()
...
Feng Wei (1):
      staging: iio: adt7316: replace irqd_get_trigger_type with irq_get_tri=
gger_type

Gabriel Shahrouzi (2):
      iio: frequency: ad9832: Remove unused parameter from data documentati=
on
      staging: iio: ad5933: Correct settling cycles encoding per datasheet

Gustavo A. R. Silva (2):
      iio: proximity: cros_ec_mkbp_proximity: Avoid -Wflex-array-member-not=
-at-end warning
...
Jonathan Cameron (79):
      iio: adc: vf610: Move claim of direct mode to caller of vf610_read_sa=
mple and use guard(mutex)
      iio: adc: vf610: Switch to sparse friendly iio_device_claim/release_d=
irect()
      iio: adc: ti-ads1100: Use guard(mutex) to allow direct returns
      iio: adc: ti-ads1100: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: adc: ti-ads1015: Use guard(mutex) and factor out code for INFO_R=
AW
      iio: adc: ti-ads1015: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: adc: mxs-lradc: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: adc: rcar: Switch to sparse friendly iio_device_claim/release_di=
rect()
      iio: light: apds9306: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: light: gp2ap020a00f: Switch to sparse friendly iio_device_claim/=
release_direct()
      iio: light: isl29125: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: light: as73211: Use guard() and move mode switch into inner writ=
e_raw fucntion
      iio: light: as73211: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: light: ltr501: Factor out IIO_INFO_RAW leg of read_raw() callbac=
k.
      iio: light: ltr501: Factor out core of write_raw() where direct mode =
claim is held.
      iio: light: ltr501: Switch to sparse friendly iio_device_claim/releas=
e_direct()
      iio: light: opt4060: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: light: rohm-bu27034: Switch to sparse friendly iio_device_claim/=
release_direct()
      iio: light: rpr0521: Factor out handling of IIO_INFO_RAW and use guar=
d()
      iio: light: rpr0521: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: light: si1145: Switch to sparse friendly iio_device_claim/releas=
e_direct()
      iio: light: st_uvis25: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: light: tcs3414: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: light: tcs3472: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: light: vcnl4000: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: light: vcnl4035: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: addac: ad74115: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: chemical: ccs811: Factor out handling of read of IIO_INFO_RAW to=
 simplify error paths.
      iio: chemical: ccs811: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: chemical: atlas-sensor: Switch to sparse friendly iio_device_cla=
im/release_direct()
      iio: chemical: scd4x: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: common: scmi: Switch to sparse friendly iio_device_claim/release=
_direct()
      iio: common: st_sensors: Switch to sparse friendly iio_device_claim/r=
elease_direct()
      iio: gyro: adxrs290: Switch to sparse friendly iio_device_claim/relea=
se_direct()
      iio: health: max30102: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: humidity: hdc100x: Use guard(mutex) to simplify code flow
      iio: humidity: hdc100x: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: humidity: hdc2010: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: humidity: hts211: Factor out everything under direct mode claim =
into helper functions.
      iio: humidity: hts211: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: imu: inv_icm42600: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: imu: inv_mpu6050: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: imu: smi240: Switch to sparse friendly iio_device_claim/release_=
direct()
 ...
 to allow direct returns
      ...
      iio: imu: st_lsm6dsx: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
      iio: magnetometer: mag3110: Factor out core of read/write_raw() and u=
se guard() to simplify code flow.
      iio: magnetometer: mag3110: Switch to sparse friendly iio_device_clai=
m/release_direct()
      iio: magnetometer: rm3100: Switch to sparse friendly iio_device_claim=
/release_direct()
      iio: pressure: dlhl60d: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: pressure: icp10100: Switch to sparse friendly iio_device_claim/r=
elease_direct()
      iio: pressure: mpl3115: factor out core of IIO_INFO_RAW read to simpl=
ify code flow
      iio: pressure: mpl3115: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: pressure: ms5611: Switch to sparse friendly iio_device_claim/rel=
ease_direct()
      iio: pressure: rohm-bm1390: Switch to sparse friendly iio_device_clai=
m/release_direct()
      iio: pressure: zpa2326: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: proximity: hx9023s: Switch to sparse friendly iio_device_claim/r=
elease_direct()
      iio: proximity: pulsed-light: Switch to sparse friendly iio_device_cl=
aim/release_direct()
      iio: proximity: sx9500: Switch to sparse friendly iio_device_claim/re=
lease_direct()
      iio: temp: maxim_thermocouple: Switch to sparse friendly iio_device_c=
laim/release_direct()
      iio: temp: maxim_thermocouple: Drop unused mutex.h include.
      staging: iio: ad5933: Switch to sparse friendly iio_device_claim/rele=
ase_direct()
...
of storage
      iio: adc: ti-ads131e08: Use new iio_push_to_buffers_with_ts() to prov=
ide length sanity check.
      iio: adc: Use iio_push_to_buffers_with_ts() to provide length for run=
time checks.
      iio: accel: Use iio_push_to_buffers_with_ts() to provide length for r=
untime checks.
      iio: accel: hid: Use iio_push_to_buffers_with_ts() to provide length =
for runtime checks.
      iio: chemical: Use iio_push_to_buffers_with_ts() to provide length fo=
r runtime checks.
      iio: temperature: Use iio_push_to_buffers_with_ts() to provide length=
 for runtime checks.
      iio: resolver: Use iio_push_to_buffers_with_ts() to provide length fo=
r runtime checks.
      iio: proximity: irsd200: Use a struct for scan and iio_push_to_buffer=
s_with_ts()
      iio: proximity: Use iio_push_to_buffers_with_ts() to provide length f=
or runtime checks.
      iio: pressure: zpa2326: Use aligned_s64 for the timestamp
      iio: pressure: Use iio_push_to_buffers_with_ts() to provide length fo=
r runtime checks.
      iio: magnetometer: Use iio_push_to_buffers_with_ts() to provide lengt=
...
Marcus Folkesson (3):
      iio: adc: mcp3911: fix device dependent mappings for conversion resul=
t registers
...
Uwe Kleine-K=C3=B6nig (3):
      ...
      iio: adc: ad7124: Remove ability to write filter_low_pass_3db_frequen=
cy
...
++++
 ...
 create mode 100644 Documentation/devicetree/bindings/iio/adc/nuvoton,nct72=
01.yaml
...
yaml
 create mode 100644 Documentation/devicetree/bindings/iio/chemical/winsen,m=
hz19b.yaml
 create mode 100644 Documentation/devicetree/bindings/iio/dac/adi,ad3530r.y=
aml
