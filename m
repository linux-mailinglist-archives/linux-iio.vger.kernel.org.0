...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B5DE41F832E
	for <lists+linux-iio@lfdr.de>; Sat, 13 Jun 2020 14:18:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726258AbgFMMSD (ORCPT <rfc822;lists+linux-iio@lfdr.de>);
        Sat, 13 Jun 2020 08:18:03 -0400
Received: from www381.your-server.de ([78.46.137.84]:55082 "EHLO
        www381.your-server.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726196AbgFMMSC (ORCPT
        <rfc822;linux-iio@vger.kernel.org>); Sat, 13 Jun 2020 08:18:02 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=metafoo.de;
        ...
        bh=NcaJjD12rKsg7VxlvZtrfLdJii0/KuLmNYDK/hgYs20=; b=i8gOwPKTLI9Fqgg94isR2PpPAK
        ;
Received: from sslproxy02.your-server.de ([78.47.166.47])
        by www381.your-server.de with esmtpsa (TLSv1.2:DHE-RSA-AES256-GCM-SHA384:256)
        (Exim 4.89_1)
        (envelope-from <lars@metafoo.de>)
        id 1jk56i-00024Z-Ru; Sat, 13 Jun 2020 14:17:56 +0200
Received: from [82.135.65.124] (helo=lars-desktop.fritz.box)
        by sslproxy02.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <lars@metafoo.de>)
        id 1jk56h-0002ZR-UM; Sat, 13 Jun 2020 14:17:56 +0200
...
Subject: [PATCH] iio: Remove superfluous of_node assignments
Date:   Sat, 13 Jun 2020 14:17:15 +0200
Message-Id: <20200613121715.11898-1-lars@metafoo.de>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Authenticated-Sender: lars@metafoo.de
X-Virus-Scanned: Clear (ClamAV 0.102.3/25841/Fri Jun 12 14:56:29 2020)
